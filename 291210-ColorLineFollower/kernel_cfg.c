...
const AlarmType cyclic_alarm_ReadColour = 0;
const AlarmType cyclic_alarm_ManageState = 1;
const AlarmType cyclic_alarm_ReadButtons = 2;

DeclareTask(ReadColour);
static void _activate_alarm_cyclic_alarm_ReadColour( void );
static void _activate_alarm_cyclic_alarm_ReadColour( void )
{ (void)ActivateTask( ReadColour ); }

DeclareTask(ManageState);
static void _activate_alarm_cyclic_alarm_ManageState( void );
static void _activate_alarm_cyclic_alarm_ManageState( void )
{ (void)ActivateTask( ManageState ); }

DeclareTask(ReadButtons);
static void _activate_alarm_cyclic_alarm_ReadButtons( void );
static void _activate_alarm_cyclic_alarm_ReadButtons( void )
{ (void)ActivateTask( ReadButtons ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, 0, 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_cyclic_alarm_ReadColour, _activate_alarm_cyclic_alarm_ManageState, _activate_alarm_cyclic_alarm_ReadButtons, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 2, 10, 100, };
