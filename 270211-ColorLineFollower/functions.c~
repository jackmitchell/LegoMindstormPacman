...
* @param line_side the side of the line the robot should follow
*/
  ...
  if (line_side == FOLLOW_RIGHT) {
    ...
    switch(direction) {
      ...
      case FOLLOW:
        ...
        if (old_color != BLACK || old_color != UNKNOWN) {
          motor_right = 25;
          motor_left = 28;
        }
    ...
    /* Stop motors going above or below certain speed thresholds */
  	set_motor_threshold(25,60,30,70);  
    ...
    /* Stop motors going above or below certain speed thresholds */ 
		set_motor_threshold(30,70,25,60);
